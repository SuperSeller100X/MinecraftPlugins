...
public record PluginConfig(
        int targetDistance,
        boolean lockChests,
        boolean lockCopperChests,
        boolean lockBarrels,
        boolean lockShulkerBoxes,
        boolean lockFurnaces,
        boolean lockDispensers,
        boolean lockHoppers,
        boolean lockBrewingStands,
        boolean lockCrafters,
        boolean lockChiseledBookshelves,
        boolean lockDecoratedPots,
        boolean lockLecterns,
        boolean lockShelves,
        boolean lockJukeboxes,
    ...
    public static PluginConfig load(FileConfiguration config, Consumer<String> warning) {
        ...
        return new PluginConfig(
                ...
                config.getBoolean("containers.copper-chests", true),
                config.getBoolean("containers.barrels", true),
                config.getBoolean("containers.shulker-boxes", true),
                config.getBoolean("containers.furnaces", true),
                config.getBoolean("containers.dispensers", true),
                config.getBoolean("containers.hoppers", true),
                config.getBoolean("containers.brewing-stands", true),
                config.getBoolean("containers.crafters", true),
                config.getBoolean("containers.chiseled-bookshelves", true),
                config.getBoolean("containers.decorated-pots", true),
                config.getBoolean("containers.lecterns", true),
                config.getBoolean("containers.shelves", true),
                config.getBoolean("containers.jukeboxes", true),
                minPasscode,
                maxPasscode,
                ...
                config.getBoolean("protection.block-hoppers", true),
